...
import { getSalesWithoutCost } from "@/lib/alert-helpers";
import { z } from "zod";

// SPRINT H: GET /api/reports/alerts/sales-without-cost - Alertas de ventas sin costos
export async function GET(req: Request) {
  try {
    ...
    return jsonResponse(salesWithoutCost, 200);
  } catch (error) {
    return handleUnexpectedError(error, "GET /api/reports/alerts/sales-without-cost");
  }
}
