...
import { getDifferences } from "@/lib/report-helpers";

// SPRINT 6: GET /api/reports/differences - Diferencias entre ventas y pagos
export async function GET(req: Request) {
  try {
    ...
    // Obtener reporte
    const report = await getDifferences(
      tenantId,
    ...
    return handleUnexpectedError(error, "GET /api/reports/differences");
  }
}
